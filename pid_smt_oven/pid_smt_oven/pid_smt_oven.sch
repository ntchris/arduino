...
U 1 1 61610D83
P 3700 1700
F 0 "D1" H 3700 1483 50  0000 C CNN
F 1 "1N4007" H 3700 1574 50  0000 C CNN
F 2 "myFootPrintLibs:D_SMA_Handsoldering" H 3700 1525 50  0001 C CNN
F 3 "http://www.vishay.com/docs/88503/1n4001.pdf" H 3700 1700 50  0001 C CNN
	1    3700 1700
	-1   0    0    1   
$EndComp
$Comp
...
Wire Wire Line
	950  2350 1650 2350
$Sheet
S 1500 4500 1950 900 
U 61610B79
F0 "power__output" 50
F1 "power_output.sch" 50
F2 "enable20VHeater" I L 1500 4900 50 
F3 "20VHeaterPower" O R 3450 4900 50 
F4 "5V" I L 1500 4650 50 
F5 "relayTrigger" I L 1500 5200 50 
$EndSheet
$Comp
L Device:CP C6
U 1 1 616213FF
P 3400 1950
F 0 "C6" H 3518 1996 50  0000 L CNN
F 1 "470uf" H 3518 1905 50  0000 L CNN
F 2 "myFootPrintLibs:CP_Radial_D8.0mm_P3.80mm" H 3438 1800 50  0001 C CNN
...
U 1 1 616254AF
P 3400 2200
F 0 "#PWR010" H 3400 1950 50  0001 C CNN
...
Wire Wire Line
	3400 2200 3400 2100
$Comp
L mySymbolLibrary:mini360_dcdc_stepdown a1
U 1 1 6162BF99
P 5100 1800
F 0 "a1" H 5100 2125 50  0000 C CNN
F 1 "mini360_dcdc_stepdown" H 5100 2034 50  0000 C CNN
F 2 "myFootPrintLibs:mini360_dcdc_buck_module" H 5100 1800 50  0001 C CNN
...
F 1 "220uf" H 5668 2355 50  0000 L CNN
...
F 1 "47uf" H 6865 2355 50  0000 L CNN
F 2 "Capacitor_SMD:C_1206_3216Metric_Pad1.33x1.80mm_HandSolder" H 6788 2250 50  0001 C CNN
...
F 1 "22uf" H 6115 2355 50  0000 L CNN
...
U 1 1 616C03AE
P 6750 2600
F 0 "#PWR017" H 6750 2350 50  0001 C CNN
...
F 1 "22uf" H 9965 1405 50  0000 L CNN
...
U 616BCAEC
F0 "20VInputDetect" 50
F1 "20VInputDetect.sch" 50
F2 "20VDetect" O R 10000 5550 50 
F3 "env_temp_adc" O R 10000 5850 50 
F4 "enable_env_temp_check" I L 8850 5400 50 
$EndSheet
...
U 1 1 61740979
P 6400 2150
F 0 "D7" H 6400 1933 50  0000 C CNN
F 1 "1N4007" H 6400 2024 50  0000 C CNN
F 2 "myFootPrintLibs:D_SMA_Handsoldering" H 6400 1975 50  0001 C CNN
F 3 "http://www.vishay.com/docs/88503/1n4001.pdf" H 6400 2150 50  0001 C CNN
	1    6400 2150
	-1   0    0    1   
$EndComp
Wire Wire Line
